...
Первый этап показал, что на данный момент можно выполнить последовательные скользящие миграции только от версии 4.4 до 5.0, от версии 5.0 до 6.0, от версии 6.0 до 7.0. Это мы и проделаем сегодня.
